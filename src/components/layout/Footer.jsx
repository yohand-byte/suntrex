...
export default function Footer() {
  ...
  return (
    <footer style={{padding:"40px 40px 24px",borderTop:"1px solid #e4e5ec"}}>
      ...
      <div style={{borderTop:"1px solid #e4e5ec",paddingTop:16,display:"flex",justifyContent:"space-between",alignItems:"center"}}><span style={{fontSize:12,color:"#7b7b7b"}}>2026 suntrex</span><div style={{display:"flex",gap:12}}><span style={{fontSize:14,fontWeight:700,color:"#6366f1"}}>stripe</span><span style={{fontSize:11,fontWeight:700,color:"#999"}}>VISA</span><span style={{fontSize:11,fontWeight:700,color:"#999"}}>MC</span></div><a href="#" style={{fontSize:12,color:"#7b7b7b",textDecoration:"none"}}>{t("footer.legal")}</a></div>
    </footer>
  );
}
