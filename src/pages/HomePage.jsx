    ...
    <>
      ...
      <section style={{padding:isMobile?"40px 16px":"56px 40px",textAlign:"center",background:"#1a1a1a",color:"#fff"}}>
        ...
        <div style={{display:"flex",flexDirection:isMobile?"column":"row",gap:12,justifyContent:"center",alignItems:"center"}}>
          ...
          <button onClick={onShowRegister} style={{padding:"14px 32px",borderRadius:24,border:"1px solid rgba(255,255,255,0.3)",background:"transparent",color:"#fff",fontSize:14,fontWeight:500,cursor:"pointer",fontFamily:"inherit",width:isMobile?"100%":"auto"}}>{thome("cta.startSelling")}</button>
        </div>
      </section>
